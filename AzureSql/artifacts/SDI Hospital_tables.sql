...
CREATE TABLE [Raw].[diagnosis] (
     ...
     [DIML_diagnosis_ID] int NOT NULL,
     [DIML_ExecutionLog_ID] int NOT NULL,
     [DIML_Batch_ID] int NOT NULL,
     [DIML_KeyHash] binary NOT NULL,
     [DIML_RowHash] binary NOT NULL,
     [DIML_CreateTime_UTC] datetime2 NOT NULL,
     [DIML_LastUpdateTime_UTC] datetime2 NOT NULL,
     [DIML_IsDeleted] bit NOT NULL,
     [DIML_CDC_Action] char NOT NULL,
     [DIML_SCD2_IsCurrent] bit NOT NULL,
     [DIML_SCD2_StartTime] datetime2 NOT NULL,
     [DIML_SCD2_EndTime] datetime2 NOT NULL
)
...
CREATE TABLE [Raw].[encounters] (
     ...
     [create_date] datetime2(7) NULL,
     [update_date] datetime2(7) NULL,
     [DIML_encounters_ID] int NOT NULL,
     [DIML_ExecutionLog_ID] int NOT NULL,
     [DIML_Batch_ID] int NOT NULL,
     [DIML_KeyHash] binary NOT NULL,
     [DIML_RowHash] binary NOT NULL,
...
CREATE TABLE [Raw].[encounters_items] (
     ...
     [create_date] datetime2(7) NULL,
     [update_date] datetime2(7) NULL,
     [DIML_encounters_items_ID] int NOT NULL,
     [DIML_ExecutionLog_ID] int NOT NULL,
     [DIML_Batch_ID] int NOT NULL,
     [DIML_KeyHash] binary NOT NULL,
     [DIML_RowHash] binary NOT NULL,
...
CREATE TABLE [Raw].[hospitals] (
     ...
     [create_date] datetime2(7) NULL,
     [update_date] datetime2(7) NULL,
     [DIML_hospitals_ID] int NOT NULL,
     [DIML_ExecutionLog_ID] int NOT NULL,
     [DIML_Batch_ID] int NOT NULL,
     [DIML_KeyHash] binary NOT NULL,
     [DIML_RowHash] binary NOT NULL,
...
CREATE TABLE [Raw].[patient_diagnosis] (
     ...
     [create_date] datetime2(7) NULL,
     [update_date] datetime2(7) NULL,
     [DIML_patient_diagnosis_ID] int NOT NULL,
     [DIML_ExecutionLog_ID] int NOT NULL,
     [DIML_Batch_ID] int NOT NULL,
     [DIML_KeyHash] binary NOT NULL,
     [DIML_RowHash] binary NOT NULL,
...
CREATE TABLE [Raw].[categories] (
     ...
     [create_date] datetime2(7) NULL,
     [update_date] datetime2(7) NULL,
     [DIML_categories_ID] int NOT NULL,
     [DIML_ExecutionLog_ID] int NOT NULL,
     [DIML_Batch_ID] int NOT NULL,
     [DIML_KeyHash] binary NOT NULL,
     [DIML_RowHash] binary NOT NULL,
